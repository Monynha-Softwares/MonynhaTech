...
drop policy if exists "Public can view published docs" on public.docs;
...
drop policy if exists "Public can view blog post categories" on public.blog_posts_categories;
...
drop policy if exists "Authenticated can update own media" on storage.objects;
